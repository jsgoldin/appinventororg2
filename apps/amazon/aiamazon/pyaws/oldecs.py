...
# wolber added this fix for buildrequest using http://blog.umlungu.co.uk/blog/2009/jul/12/pyaws-adding-request-authentication/
...
def query(url):
	...
	Exception is raised if there is errors"""
 	...
 	# David Wolber commented out this because app engine doesn't handle sockets
