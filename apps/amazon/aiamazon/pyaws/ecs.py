...
# downloaded from http://blog.umlungu.co.uk/blog/2009/jul/12/pyaws-adding-request-authentication/
# MODIFIED BY David Wolber to get it to work with App Engine
...
def query(url):
	...
	Exception is raised if there is errors"""
        ...
        # DWW commented this out as app engine doesn't handle sockets
...
def ItemLookup(ItemId, IdType=None, SearchIndex=None, MerchantId=None, Condition=None, DeliveryMethod=None, ISPUPostalCode=None, OfferPage=None, ReviewPage=None, VariationPage=None, ResponseGroup=None, AWSAccessKeyId=None, AssociateTag=None): 
	'''ItemLookup in ECS'''
...
def XMLItemLookup(ItemId, IdType=None, SearchIndex=None, MerchantId=None, Condition=None, DeliveryMethod=None, ISPUPostalCode=None, OfferPage=None, ReviewPage=None, VariationPage=None, ResponseGroup=None, AWSAccessKeyId=None, AssociateTag=None): 
